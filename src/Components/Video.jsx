...
import { Calendar, Search, Filter, Plus, List, X, ChevronDown, ChevronLeft, ChevronRight } from 'lucide-react';
          ...
          <div className="grid grid-cols-7 gap-2">
            ...
            {days.map((day, index) => {
              ...
              return (
                <div
                  key={day}
                  className={`min-h-[100px] p-2 border rounded-lg hover:bg-blue-50 ${
                    day === currentDate.getDate() ? 'ring-2 ring-blue-500' : ''
                  }`}
                >
                  <div className="font-medium text-blue-700 mb-2">{day}</div>
                  {meetings
                    .filter(
                      (meeting) =>
                    ...
                    .map((meeting) => (
                      <div
                        key={meeting.id}
                        className="text-xs bg-blue-100 p-1 rounded mb-1 truncate text-blue-700"
                      >
                        {meeting.title}
                      </div>
                    ))}
          ...
          <div className="grid grid-cols-7 gap-2">
            {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((day) => (
              <div key={day} className="border rounded-lg p-4">
                <div className="font-medium text-blue-700 mb-4">{day}</div>
                <div className="space-y-2">
                  {meetings.map((meeting) => (
                    <div
                      key={meeting.id}
                      className="bg-blue-100 p-2 rounded text-sm text-blue-700"
                    >
                      {meeting.title}
            ...
            <div className="grid grid-cols-1 gap-4">
              {Array.from({ length: 24 }, (_, i) => (
                <div key={i} className="flex items-start border-t py-2">
                  <div className="w-20 text-sm text-blue-600">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-4 mb-4">
          ...
          <div className="flex flex-wrap items-center gap-4 lg:gap-8">
            ...
            <div className="relative">
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 border rounded text-blue-600 text-sm hover:border-blue-400 min-w-[200px]"
                >
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                className="px-3 py-1.5 border rounded text-sm text-blue-600 hover:border-blue-400 min-w-[120px]"
            ...
            <div className="relative flex-grow lg:max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-1.5 border rounded text-sm focus:border-blue-400 focus:ring focus:ring-blue-200"
                value={searchQuery}
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <button className="flex items-center gap-2 px-3 py-1.5 border rounded text-sm text-blue-600 hover:bg-blue-50">
              <X className="h-4 w-4" />
              Clear
            </button>
          </div>
          ...
          <div className="mt-4 p-4 border rounded-lg bg-blue-50">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  className="w-full px-3 py-1.5 border rounded text-sm text-blue-600"
        ...
        <div className="flex items-center justify-between mt-4">
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 bg-blue-500 text-white px-4 py-2 rounded text-sm hover:bg-blue-600"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 border px-4 py-2 rounded text-sm text-blue-600 hover:bg-blue-50"
            >
              Export
            </button>
          </div>
      ...
      {view === 'table' && (
        <div className="bg-white shadow-sm mt-4 mx-4 rounded-lg overflow-x-auto">
          <table className="min-w-full">
            <thead>
              <tr className="border-b bg-blue-50">
                ...
                <th className="text-left py-4 px-4 font-medium text-blue-700 text-sm">
                  Meeting Id
                </th>
                <th className="text-left py-4 px-4 font-medium text-blue-700 text-sm">
                  Meeting Title
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between p-4 border-t gap-4">
            <div className="flex items-center gap-2">
              <span className="text-blue-600 text-sm">Show</span>
              <select
              ...
              <span className="text-blue-600 text-sm">entries</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              <button
                className="px-3 py-1 border rounded text-sm text-blue-400"
                disabled
              >
                Previous
              </button>
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-3 py-1 border rounded text-sm hover:bg-blue-50 text-blue-600"
              >
                Today
              </button>
            </div>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`px-3 py-1 rounded text-sm ${
                  calendarView === 'month'
                    ? 'bg-blue-500 text-white'
                    : 'border hover:bg-blue-50 text-blue-600'
                }`}
              >
                Month
              </button>
      ...
      {showAddMeetingModal && (
        <div className="fixed inset-0 bg-blue-900/50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div className="p-6">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-3 py-2 border rounded focus:border-blue-400 focus:ring focus:ring-blue-200"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-blue-700 mb-1">
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 border rounded focus:border-blue-400 focus:ring focus:ring-blue-200">
            ...
            <div className="px-6 py-4 bg-blue-50 rounded-b-lg flex justify-end gap-2">
              <button
                onClick={() => setShowAddMeetingModal(false)}
                className="px-4 py-2 text-sm text-blue-600 hover:bg-blue-100 rounded"
              >
                Cancel
              </button>
